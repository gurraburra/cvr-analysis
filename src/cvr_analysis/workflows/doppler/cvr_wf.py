...
cvr_analysis_wf = ProcessWorkflow(
    (
        ...
        # regression 
        (ProcessWorkflow.input._, regression_wf.input[('baseline_strategy', 'correlation_window', 'correlation_phat', 'correlation_peak_threshold', 'correlation_multi_peak_strategy', 'align_regressor_lower_bound', 'align_regressor_upper_bound', 'show_pbar', 'maxcorr_bipolar')]),
