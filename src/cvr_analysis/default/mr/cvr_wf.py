...
cvr_analysis_wf = ProcessWorkflow(
    (
        ...
        # regression 
        (ProcessWorkflow.input._, regression_wf.input.all - regression_wf.input[("confounds_df", "depvars_timeseries", "depvars_units", "down_sampling_factor", "global_timeseries", "psc_regressor", "regressor_timeseries", "regressor_units", "sample_time", "timeseries_masker")]),
        (ProcessWorkflow.input.regressor == ValueNode("global-signal").output.value, regression_wf.input.psc_regressor),
        (load_data_wf.output.bold_units, regression_wf.input.depvars_units),
        ...
        (regression_wf.output.depvars_signal_units, save_data_node.input.bold_units),
        ...
        (regression_wf.output.depvarsIter_down_sampled_depvars_signal_timeseries, save_data_node.input.bold_postproc_timeseries),
        ...
        (regression_wf.output.depvarsIter_down_sampled_aligned_regressor_signal_timeseries, save_data_node.input.bold_aligned_regressor_timeseries),
        ...
        (regression_wf.output.depvarsIter_down_sampled_depvars_signal_predictions, save_data_node.input.bold_predictions),
