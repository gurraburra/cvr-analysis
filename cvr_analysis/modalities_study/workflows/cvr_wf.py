...
cvr_analysis_wf = ProcessWorkflow(
    (
        ...
        (regression_wf.output.global_autocorrelation_timeshifts, conditionally_save_data.input.global_autocorrelation_timeshifts),
        (regression_wf.output.global_autocorrelation_correlations, conditionally_save_data.input.global_autocorrelation_correlations),
        ...
        (regression_wf.output.co2_autocorrelation_timeshifts, conditionally_save_data.input.co2_autocorrelation_timeshifts),
        (regression_wf.output.co2_autocorrelation_correlations, conditionally_save_data.input.co2_autocorrelation_correlations),
