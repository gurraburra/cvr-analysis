...
cvr_analysis_wf = ProcessWorkflow(
    (
        ...
        # regression 
        (ProcessWorkflow.input._, regression_wf.input[('nr_parallel_processes', 'show_pbar', 'confound_regressor_correlation_threshold', 'use_co2_regressor', 'initial_global_align_lower_bound', 'initial_global_align_upper_bound', 'align_regressor_lower_bound', 'align_regressor_upper_bound', 'maxcorr_bipolar', 'correlation_window', 'correlation_phat', 'correlation_multi_peak_strategy', "filter_timeshifts_maxcorr_threshold", "filter_timeshifts_size", "filter_timeshifts_filter_type", 'baseline_strategy')]),
        ...
        # regression data
        (regression_wf.output.down_sampled_global_signal_timeseries, conditionally_save_data.input.global_preproc_timeseries),
        (regression_wf.output.global_signal_rms, conditionally_save_data.input.global_rms),
        (regression_wf.output.global_signal_autocorrelation_timeshifts, conditionally_save_data.input.global_autocorrelation_timeshifts),
        (regression_wf.output.global_signal_autocorrelation_correlations, conditionally_save_data.input.global_autocorrelation_correlations),
        (regression_wf.output.down_sampled_global_aligned_co2_signal_timeseries, conditionally_save_data.input.global_aligned_co2_timeseries),
