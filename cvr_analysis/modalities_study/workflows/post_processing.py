...
detrend_wf = ProcessWorkflow(
    (
        ...
        (ProcessWorkflow.input.detrend_type, detrend_bold_timeseries.input.detrend_type),
        (ProcessWorkflow.input.detrend_linear_order, detrend_bold_timeseries.input.linear_order),
        (ProcessWorkflow.input.detrend_endpoint_average, detrend_bold_timeseries.input.endpoint_average),
        ...
        (ProcessWorkflow.input.detrend_type, detrend_confounds_df.input.detrend_type),
        (ProcessWorkflow.input.detrend_linear_order, detrend_confounds_df.input.linear_order),
        (ProcessWorkflow.input.detrend_endpoint_average, detrend_confounds_df.input.endpoint_average),
        ...
        (ProcessWorkflow.input.detrend_type, detrend_co2_series.input.detrend_type),
        (ProcessWorkflow.input.detrend_linear_order, detrend_co2_series.input.linear_order),
        (ProcessWorkflow.input.detrend_endpoint_average, detrend_co2_series.input.endpoint_average),
...
signal_processing_wf = ProcessWorkflow(
    (  
        ...
        # detrend wf
        (ProcessWorkflow.input.detrend_type, detrend_wf.input.detrend_type),
        (ProcessWorkflow.input.detrend_linear_order, detrend_wf.input.detrend_linear_order),
        (ProcessWorkflow.input.detrend_endpoint_average, detrend_wf.input.detrend_endpoint_average),
...
post_processing_wf = ProcessWorkflow(
    (
        ...
        # signal processing wf
        (ProcessWorkflow.input._, signal_processing_wf.input[("min_sample_freq", "analysis_start_time", "analysis_end_time",  "detrend_type", "detrend_linear_order", "detrend_endpoint_average", "temporal_filter_freq")]),
