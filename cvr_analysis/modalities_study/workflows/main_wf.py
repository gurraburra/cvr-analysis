...
cvr_analysis_wf = ProcessWorkflow(
    (
        ...
        # regression 
        (ProcessWorkflow.input._, regression_wf.input[('motion_regressor_correlation_threshold', 'use_co2_regressor', 'align_regressor_lower_bound', 'align_regressor_upper_bound', 'maxcorr_bipolar')]),
        ...
        (post_processing_wf.output.temporal_filtered_detrended_confounds_df, regression_wf.input.confounds_df),
        ...
        (regression_wf.output.regression_confounds_df, conditionally_save_data.input.regression_confounds_df),
        (regression_wf.output.global_preproc_timeseries, conditionally_save_data.input.global_preproc_timeseries),
        ...
        (regression_wf.output.global_aligned_co2_timeseries, conditionally_save_data.input.global_aligned_co2_timeseries),
        ...
        (regression_wf.output.boldIter_bold_preproc_ts, conditionally_save_data.input.bold_preproc_timeseries),
        ...
        (regression_wf.output.boldIter_aligned_regressor_timeseries, conditionally_save_data.input.bold_aligned_regressor_timeseries),
        ...
        (regression_wf.output.boldIter_predictions, conditionally_save_data.input.bold_predictions),
